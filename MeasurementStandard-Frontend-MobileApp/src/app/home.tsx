...
// // //   // console.log('this is the examTypes : ',examTypes)
// // //   // console.log('this is the sections : ',sections)
...
// //   const { user } = useSelector((state: RootState) => state.auth);
// //   const { data: progress } = useSelector((state: RootState) => state.userProgress);
// //   const { examTypes, sections } = useSelector((state: RootState) => state.sections);
...
// //     <SafeAreaView
// //       edges={["top", "left", "right", "bottom"]}
// //       // Force flex 1 explicitly so the container doesn't collapse
...
// //         <CategoryGrid
// //           // Ensure we always pass an array, even if state is undefined
// //           examTypes={examTypes || []}
// //           onExamPress={(examType) => {
// //             router.push({
// //               pathname: "/exam-type",
...
//           name={displayName}
//           avatar={
//             profile?.profile_picture || require("@/assets/images/avatar.png")
//           }
//         />
